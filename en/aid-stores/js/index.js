        ...
        return {
            ...
            sceneList: [
                ...
                },
                {
                    ...
                    solutions: ['Pure Tone','Sound Field','Speech Test','VRA Test','IA Test','OAE Test'],
                },
                {
                    name: 'ABR/ASSR Test',
                ...
                },
                {
                    ...
                    solutions: ['After Sales'],
                },
                {
                    name: 'Display Supplies',
                    ...
                    solutions: ['Display Props','Display','BTE clip','Supplies'],
                },
                {
                    name: 'Earmold Production',
                ...
                {
                    name: 'Fitting Training And Qualification Assessment',
            ...
            solutionList: [
                {
                    solutionName: 'Ear Check',
                    solutionIcon: 'assets/img/ErJianCha.png?v20230222',
                    productIds: [33,34,14],
                },
                {
                    solutionName: 'Pure Tone',
                    solutionIcon: 'assets/img/ChunYinCeShi.png?v20230222',
                    productIds: [49,74],
                },
                {
                    solutionName: 'Sound Field',
                    solutionIcon: 'assets/img/ShengChangCeShi.png?v20230222',
                    productIds: [35,49,74,36],
                },
                {
                    solutionName: 'Speech Test',
                    solutionIcon: 'assets/img/YanYuCeShi.png?v20230222',
                    productIds: [35,49,74,36],
                },
                {
                    solutionName: 'VRA Test',
                    solutionIcon: 'assets/img/VRACeShi.png?v20230222',
                    productIds: [37,49,74,36],
                },
                {
                    solutionName: 'IA Test',
                    solutionIcon: 'assets/img/ShengDaoKangCeShi.png?v20230222',
                    productIds: [38],
                },
                {
                    solutionName: 'OAE Test',
                    solutionIcon: 'assets/img/ErShengFaSheCeShi.png?v20230222',
                    productIds: [83,60],
                },

                {
                    solutionName: 'Objective Test',
                    solutionIcon: 'assets/img/KeGuanJianCe.png?v20230222',
                    productIds: [84,85,40,49],
                },
                {
                    solutionName: 'Fitting Room',
                    solutionIcon: 'assets/img/YanPeiShi.png?v20230222',
                    productIds: [86,8,13,40],
                },
                {
                    solutionName: 'After Sales',
                    solutionIcon: 'assets/img/ShouHou.png?v20230222',
                    productIds: [56,61,25,41,12,53],
                },
                {
                    solutionName: 'Display Props',
                    solutionIcon: 'assets/img/ChenLieDaoJu.png?v20230222',
                    productIds: [5,43,27],
                },
                {
                    solutionName: 'Display',
                    solutionIcon: 'assets/img/ZhanShiJia.png?v20230222',
                    productIds: [16,75,76,77,78,79,80,81],
                },
                {
                    solutionName: 'BTE clip',
                    solutionIcon: 'assets/img/GuaSheng.png?v20230222',
                    productIds: [17,99,100,101,102,103],
                },
                {
                    solutionName: 'Supplies',
                    solutionIcon: 'assets/img/PeiJianHaoCai.png?v20230222',
